$(document).ready(function () {
    ...
    var highScore = function (initial, newHighScore) {
        $('#plot').append(`
    <div class = "input-group mb-3">
        <div class = 'input-group-prepend'>
            <div class="input-group-text bg-success">
            </div>
             <input type='text' class='form-control' placeholder='log your score' value='${initial}: ${newHighScore}' aria-describedby='basic-addon1'>
        </div>
    ...
    if (initials !== null) {
        ...
        for (var initial of initialsArray) {
            highScore(initial, newHighScore);
        }
    }
    else {
        initialsArray = [];
